...
{
    public static readonly IReadOnlyList<IWeapon> Weapons = [ new NoWeapon(), new SilverSword(), new Mace(), new Staff()];
    ...
    public static readonly IReadOnlyList<IArmor> Armors = [new NoArmor(), new Scales(), new ChainMail(), new PlateArmor()];
}